...
public enum ModArmorMaterials implements ArmorMaterial {
    CELESTIAL_BRONZE("celestial_bronze", 26, new int[]{ 1, 0, 0, 0 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, ()-> Ingredient.of(ModItems.CELESTIAL_BRONZE_INGOT.get()));
    ...
    public String getName() {
        return MythsMod.MOD_ID+":"+this.name;
    }
